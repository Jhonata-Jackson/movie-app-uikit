...
struct Constants {
    ...
    static let YOUTUBE_API_KEY =  Bundle.main.object(forInfoDictionaryKey: "YOUTUBE_API_KEY") as? String ?? ""
...
class APICaller {
    ...
    func getMovie(with query: String, completion: @escaping (Result<VideoData, Error>) -> Void) {
